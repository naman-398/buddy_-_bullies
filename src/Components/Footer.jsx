...
const Footer = () => {
  return (
    <div>
      <footer
        id="join"
        className="bg-img1 bg-color bg-footer pb-4 mt-4 mt-md-0"
      >
        <Container className="footer-padding">
          <div className="lh-124 color-light ff-poppins fs-lg fw-6 text-center">
            JOIN US
          </div>
          <Row className="row lg-pt-0 pt-4 ">
            <Col md={5} lg={6}>
              <p className="margin-top-footer-logo fs-md color-light ff-poppins fw-5 lh-124">
                LOGO
              </p>
              <p className="footer-para fs-3sm ff-poppins color-light fw-4 lh-150">
              ...
              <a
                href="mailto:namanjyani95200@gmail.com?subject = Feedback&body = Message" target="_blank"
                className="email color-light ff-poppins text-decoration-none mb-5"
              >
                Email@gmail.com
              </a>
            </Col>
            <Col lg={6} md={7} className="col-lg-6 col-md-7 col-12 pt173 ">
              <Row className="row">
                <Col className="col-6 d-flex flex-column align-items-xl-end align-items-sm-center">
                  <ul className="ps-0">
                    <li className="cursor-pointer">
                      <a
                        href="#"
                        className="resource text-decoration-none mb-5"
                      >
                        Resources
                      </a>
                    </li>
                    <li className="cursor-pointer">
                      <a
                        href="#roadmap"
                        className="roadmap1 text-decoration-none pb-2 footer-icon"
                      >
                        Roadmap
                      </a>
                    </li>
                ...
                <Col className="col-6 d-flex align-items-sm-center flex-column">
                  <a href="#" className="community text-decoration-none">
                    Community
                  </a>
                  <div className="pt-3 d-flex align-items-center gap-3">
                    ...
                    <a
                      href="https://discord.com/channels/@me/1159027355889700868"
                      target="_blank"
                      className="footer-icon-svg"
                    >
                      <svg
